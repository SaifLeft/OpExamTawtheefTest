...
namespace TawtheefTest.DTOs
{
  public class CreateQuestionSetDto
  {
    ...
    public string ContentSourceType { get; set; } // topic, text, link, youtube, document, image, audio, video
    ...
    public string? NumberOfCorrectOptions { get; set; } = "auto"; // available for multiple choice and true/false
  }
}
